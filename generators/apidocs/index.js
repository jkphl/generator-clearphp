    ...
    initializing() {
        ...
        if (this.abort) {
            if (this.options.nested) {
                ...
                this.log(yosay('YO! I\'m skipping the "apidocs" subgenerator of jkphl\'s PHP project kickstarter because it has already been run before!'));
            }
        } else if (!this.options.nested) {
            this.log(yosay('WELCOME! You\'re using the "apidocs" subgenerator of jkphl\'s PHP project kickstarter.'));
        }
        this.log();
