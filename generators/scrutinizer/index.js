    ...
    initializing() {
        ...
        if (this.abort) {
            if (this.options.nested) {
                ...
                this.log(yosay('YO! I\'m skipping the "scrutinizer" subgenerator of jkphl\'s PHP project kickstarter because it has already been run before!'));
            }
        } else if (!this.options.nested) {
            this.log(yosay('WELCOME! You\'re using the "scrutinizer" subgenerator of jkphl\'s PHP project kickstarter.'));
        }
        this.log();
