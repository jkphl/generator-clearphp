...
module.exports = class extends Generator {
    ...
    prompting() {
        ...
        console.log(yosay('Welcome to the Clear Architecture PHP project generator! For more information please visit http://jk.is/ca'));
        ...
        if (this._shouldRun('codeclimate')) {
            prompts.push({
                name: 'codeclimate',
                message: 'What\'s the Code Climate Test Reporter ID?',
    ...
    configuring() {
        ...
        // If the main stage should be run
        if (this._shouldRun('main')) {
            this.composerRequire.push('clue/graph-composer', 'phpunit/phpunit', 'squizlabs/php_codesniffer');
        }
        ...
        if (this._shouldRun('coverage')) {
            this.composerRequire.push('php-coveralls/php-coveralls');
    ...
    writing() {
        ...
        if (this._shouldRun('main')) {
            ...
            this._template('main/files/README.md', 'README.md', this.config.getAll());
        }
